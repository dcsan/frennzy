...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		private string _False = string.Empty;
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/Frennzy_Nuh-Uh.Screens;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string False
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.False;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.False = value;
			}
		}
	}
}
